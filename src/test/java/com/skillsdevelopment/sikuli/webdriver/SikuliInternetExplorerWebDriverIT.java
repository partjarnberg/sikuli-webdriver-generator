...
public class SikuliInternetExplorerWebDriverIT extends BaseIntegrationTest {
    ...
    @Test
    public void findImageElement() throws IOException, InterruptedException {
        URL coolSmiley = ResourceHandler.getResource("explorer-cool-smiley.png");
    ...
    public void surfUsingImageRecognition() throws IOException, InterruptedException {
        URL coolSmiley = ResourceHandler.getResource("explorer-cool-smiley.png");
        URL superHero = ResourceHandler.getResource("explorer-superhero.png");
